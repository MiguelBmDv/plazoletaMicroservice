...
public class FoodCourtRestController {
    ...
    @PostMapping()
    public ResponseEntity<Void> saveRestaurantInFoodCourt(@RequestBody FoodCourtRequest foodCourtRequest, HttpServletRequest request){
        Long ownerId = (Long) request.getAttribute("documentNumber"); 
        foodCourtHandler.saveRestaurantInFoodCourt(foodCourtRequest, ownerId);
